...
A test for the straight hypothesis of orange juice vs ascorbic acid yields
```{r}
t.test(ToothGrowth[ToothGrowth$supp == "OJ",]$len, ToothGrowth[ToothGrowth$supp == "VC",]$len)$conf.int
...
```{r}
t.test(ToothGrowth[ToothGrowth$dose == 1.0,]$len, ToothGrowth[ToothGrowth$dose == 0.5,]$len)$conf.int
t.test(ToothGrowth[ToothGrowth$dose == 2.0,]$len, ToothGrowth[ToothGrowth$dose == 1.0,]$len)$conf.int
